...
public class Table implements TableInterface {
	...
	public synchronized int readMenu(int studentID) throws RemoteException {
		...
		// if(((TableClientProxy) Thread.currentThread()).getStudentState() !=
		// StudentStates.SELECTING_THE_COURSES) {
	...
	public synchronized int prepareOrder() throws RemoteException {
		...
		// repos.updateStudentState(firstToArriveID,
		// StudentStates.ORGANIZING_THE_ORDER);
		// }
	...
	public synchronized int joinTalk() throws RemoteException {
		...
		// repos.updateStudentState(firstToArriveID,
		// StudentStates.CHATTING_WITH_COMPANIONS);
		// }
	...
	public synchronized int endEating(int studentID) throws RemoteException {
		...
		// --------------------- DEUBG -----------------
		// System.out.println("Student "+studentID+" finished course
		// "+numberOfCoursesEaten+1+"!");
