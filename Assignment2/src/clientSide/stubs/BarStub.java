 ...
 * Stub to the Bar.
 *
 * It instantiates a remote reference to the bar. Implementation of a
...
public class BarStub {
	 ...
	 * 
	 * It is called by the first student to arrive the restaurant to call the waiter
	 ...
	 * 
	 * It is called by the last student to finish eating that next course can be
	 * brought signal chef that he can put request in the queue and waiter that he
	 * proceed his executing to collect portions It is also used by last student to
	 * arrive to signal that he wishes to pay the bill
	 */
	 ...
	 * 
	 * It is called by the waiter, he checks for pending service requests and if not
	 * waits for them
	 * 
	 * @return Character that represents the service to be executed 'e': client has
	 ...
	 * 
	 * It is called by the waiter to say goodbye to a student that's leaving the
	 * restaurant
	 * 
	 ...
	 * 
	 * It is called by the chef to alert the waiter that a portion was dished A
	 * request is puted in the queue (chef id will be N+1)
	 */
