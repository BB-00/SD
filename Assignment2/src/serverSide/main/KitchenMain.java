...
public class KitchenMain {
	...
	public static void main(String[] args) {
		...
		reposStub = new GenReposStub(reposServerName, reposPortNumb); // communication to the general repository is
																			// instantiated
		...
		while (waitConnection) {
			try {
				...
				cliProxy = new KitchenClientProxy(sconi, kitchenInterface); // start a service provider agent to address
