...
/**
 * Parametric memory. Non-instantiatable data type. It must be derived. Errors
 * are reported.
 *
...
public abstract class MemObject<R> {
	...
	/**
	 * Memory instantiation. The instantiation only takes place if the memory
	 * exists.
	 *
	...
	/**
	 * Memory write. A parametric object is written into it. Virtual method, it has
	 * to be overridden in a derived data type.
	 *
	...
	/**
	 * Memory read. A parametric object is read from it. Virtual method, it has to
	 * be overridden in a derived data type.
	 *
