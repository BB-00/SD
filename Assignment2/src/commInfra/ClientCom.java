...
public class ClientCom {
	 ...
	 *
	 * Instantiation of the communication socket and its binding to the server
	 * address. The socket input and output streams are opened.
	 *
	...
	public boolean open() {
		...
		try {
			...
			GenericIO.writelnString(Thread.currentThread().getName() + " - the server does not respond at: "
			...
			GenericIO.writelnString(
					Thread.currentThread().getName() + " - time out has occurred in establishing the connection at: "
							+ serverHostName + "." + serverPortNumb + "!");
			success = false;
		} catch (IOException e) // fatal error --- other reasons
		{
			GenericIO.writelnString(Thread.currentThread().getName()
					+ " - an indeterminate error has occurred in establishing the connection at: " + serverHostName
					+ "." + serverPortNumb + "!");
			e.printStackTrace();
			System.exit(1);
		}
