...
public class Message implements Serializable {
	...
	/**
	 * Boolean value to be transported that holds true if all portions have been
	 * delivered, false otherwise
	 */
	private boolean allPortionsDelivered;

	/**
	 * Boolean value to be transported that holds true if order has been completed,
	 * false otherwise
	 */
	...
	/**
	 * Holds a value true or false depending if is necessary to print a reportStatus
	 * line or not
	 */
	 ...
	 *
	 * @param type      message type
	 * @param stateOrId chef, waiter or student state. It can also hold student id
	 *                  or id of studentBeingAnswered or nCourses value or nPortions
	 *                  value.
	 */
	public Message(int type, int stateOrId) {
		...
		if (entity == 1) // Chef message
			chefState = stateOrId;
		else if (entity == 2) // Waiter message
			waiterState = stateOrId;
		else if (entity == 3) { // Student message
			if (msgType == MessageType.REQCW || msgType == MessageType.CWDONE || msgType == MessageType.REQHEFE)
				studentID = stateOrId;
			else if (msgType == MessageType.REQPO || msgType == MessageType.PODONE || msgType == MessageType.REQJT
					|| msgType == MessageType.JTDONE)
				studentState = stateOrId;
		} else if (entity == 4) { // Additional message
		...
		} else if (entity == 5) { // General repository messages
	 ...
	 * 
	 * @param type   message type
	 * @param bValue boolean that can have haveAllPortionsBeenDelivered,
	 *               hasOrderBeenCompleted, number of studentsAtRestaurant or
	 *               allBeenClientsServed value.
	 */
	 ...
	 * @param everybodyEaten holds the value of everybody has eaten (true if yes,
	 *                       false otherwise)
	 */
	 ...
	 */
	public int getStudentIDBeingAnswered() {
		return (studentIDBeingAnswered);
	}
	 ...
	 */
	public boolean getAllPortionsBeenDelivered() {
	 ...
	 */
	public boolean getHasOrderBeenCompleted() {
	 ...
	 */
	public boolean getStudentsAtRestaurant() {
		return (studentsAtRestaurant);
	}
	 ...
	 */
	public boolean getAllClientsBeenServed() {
		return (allClientsBeenServed);
	}
	 ...
	 */
	public boolean getEverybodyHasChosen() {
	 ...
	 */
	public boolean getHasEverybodyFinishedEating() {
		return (everybodyHasEaten);
	}
	 ...
	 */
	public boolean getAllCoursesEaten() {
		return (haveAllCoursesBeenEaten);
	}
	 ...
	 */
	public boolean getArrivedEarlier() {
		return (shouldArrivedEarlier);
	}
	 ...
	 * 
	 * @return the value of hold variable used to specify if is necessary to print
	 *         report status or not
	 */
	...
	/**
	 * For a given message type, get the entity that called it (chef, waiter or
	 * student)
	 * 
	 * @param messageType type of the message
	 * @return 1 if called by chef, 2 if called bye waiter and 3 if called by
	 *         student
	 */
	public int getEntitieFromMessageType(int messageType) {
		...
		case MessageType.WTNDONE:
		case MessageType.REQSTP:
		case MessageType.STPDONE:
		case MessageType.REQPTP:
		case MessageType.PTPDONE:
		case MessageType.REQHAPBD:
		case MessageType.HAPBDDONE:
		case MessageType.REQHOBC:
		case MessageType.HOBCDONE:
		case MessageType.REQCP:
		case MessageType.CPDONE:
		case MessageType.REQHNPR:
		case MessageType.HNPRDONE:
		case MessageType.REQCU:
		case MessageType.CUDONE:
		case MessageType.REQAL:
		case MessageType.ALDONE:
			return 1;
		// Waiter messages
		case MessageType.REQHNTC:
		case MessageType.HNTCDONE:
		case MessageType.REQRB:
		case MessageType.RBDONE:
		case MessageType.REQCPOR:
		case MessageType.CPORDONE:
		case MessageType.REQLA:
		case MessageType.LADONE:
		case MessageType.REQPB:
		case MessageType.PBDONE:
		case MessageType.REQSG:
		case MessageType.SGDONE:
		case MessageType.REQSC:
		case MessageType.SCDONE:
		case MessageType.REQRTB:
		case MessageType.RTBDONE:
		case MessageType.REQGP:
		case MessageType.GPDONE:
		case MessageType.REQHACBS:
		case MessageType.HACBSDONE:
		case MessageType.REQDP:
		case MessageType.DPDONE:
		case MessageType.REQPREB:
		case MessageType.PREBDONE:
			return 2;
		// Student messages
		case MessageType.REQENT:
		case MessageType.ENTDONE:
		case MessageType.REQCW:
		case MessageType.CWDONE:
		case MessageType.REQSW:
		case MessageType.SWDONE:
		case MessageType.REQEXIT:
		case MessageType.EXITDONE:
		case MessageType.REQSAT:
		case MessageType.SATDONE:
		case MessageType.REQRM:
		case MessageType.RMDONE:
		case MessageType.REQPO:
		case MessageType.PODONE:
		case MessageType.REQEHC:
		case MessageType.EHCDONE:
		case MessageType.REQAUOC:
		case MessageType.AUOCDONE:
		case MessageType.REQDO:
		case MessageType.DODONE:
		case MessageType.REQJT:
		case MessageType.JTDONE:
		case MessageType.REQIC:
		case MessageType.ICDONE:
		case MessageType.REQSE:
		case MessageType.SEDONE:
		case MessageType.REQEE:
		case MessageType.EEDONE:
		case MessageType.REQHEFE:
		case MessageType.HEFEDONE:
		case MessageType.REQHB:
		case MessageType.HBDONE:
		case MessageType.REQHACBE:
		case MessageType.HACBEDONE:
		case MessageType.REQSHAE:
		case MessageType.SHAEDONE:
			return 3;
		// Additional Messages
		case MessageType.REQGSBA:
		case MessageType.GSBADONE:
		case MessageType.REQGFTA:
		case MessageType.GFTADONE:
		case MessageType.REQGLTE:
		case MessageType.GLTEDONE:
		case MessageType.REQSFTA:
		case MessageType.SFTADONE:
		case MessageType.REQSLTA:
		case MessageType.SLTADONE:
		case MessageType.SHUT:
		case MessageType.SHUTDONE:
			return 4;
		// GeneralRepo Message
